	...
	factory: (require) => {
		...
		*/
		...
		function apply(ctx) {
			...
			const unregister = ctx.effect(() => configForms.whileServed([NS], () => ctx.slots.inject("settings.plugins.tab", () => ctx.slots.register({
				name: "settings.plugins.tab",
				id: NS,
				label: () => t("title"),
				locale: NS
			}, renderCard))), "dsh-hypatia-auto-memory: plugins settings tab");
